      ...
      <div className="my-5 d-flex flex-column align-items-center">
        ...
        <Button
          onClick={() => MySwal.fire({
            ...
            html: "Album API dan Posts API <br>1. Routing URL POSTS ✅<br> 2. Tambahkan Home Page ✅<br> 3. Modal POST (tampilakn userId, Id ,title, body) ✅<br> 4. Active nav link ✅ <br> 5. Dark Mode ✅",
            icon: "info",
          })}
        >
          Info WebSite
